      ...
      <ul class="slides">  
        ...
        <div class="col-md-6">                
          <div class="flex-caption">
            ...
            <h6>Come all, let's learn about computational thinking and problem solving skills. And the best part? <bold>It’s free!</bold></h6>
            <a href="/Login" class="btn-white margin-t32">Register or Login here</a>
          </div>
          </div>          
           <div class="col-md-6">
           <div class="flex-img">
           {/* <img class="img-responsive" src={logoz} alt="" /> */}
